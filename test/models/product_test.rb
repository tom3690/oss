...
test "product price must be positive" do
  ...
  product=Product.new(title: "Monopoly",
                      description: "Your mom loves this game.",
...
test "image url needs to be valid file type" do
  ...
  ok = %w{ foo.gif foo.jpg foo.png FOO.JPG Foo.Jpg http://www.foo.com/foo.jpg }
...
test "product cannont have already taken title" do
